 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://server.soap.zvezdochet.kz/", wsdlLocation = "http://zvezdochetkz.appspot.com/CalculatorService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://server.soap.zvezdochet.kz/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://zvezdochetkz.appspot.com/CalculatorService.wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://server.soap.zvezdochet.kz/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.zvezdochet.kz/", "CalculatorPort"), Calculator.class, features);
    }
